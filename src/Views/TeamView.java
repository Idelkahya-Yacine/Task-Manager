...
public class TeamView extends JFrame {
    ...
    private JTextField teamName , memmbersName , tachName,deadlineField;
    ...
    public TeamView(operationAdmin operationAdmin) {
        ...
        btnAdd.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                String titleTachName = tachName.getText();
        ...
        btnUpdate.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (selectedRow >= 0) {
                    ...
                    teamController.modifierteam(id,teamName.getText() ,Integer.parseInt(memmbersName.getText().toString()),tachName.getText(),deadlineField.getText());   
    ...
    private void selectdata() {
        if (table.getSelectedRow() >= 0) {
            int i = table.getSelectedRow();
                ...
                tachName.setText(tableModel.getValueAt(i, 3).toString());    
