...
public class UserView extends JFrame {
    ...
    private JTextField nameName , emailName , passwordName , titleTachName,deadlineField;
    ...
    public UserView(operationAdmin operationAdmin) {
        ...
        titleTachName = new JTextField(5);
        formPanel.add(titleTachName);
        ...
        btnAdd.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                String tachetitle = titleTachName.getText();
                String deadline = deadlineField.getText();
                if("".equals(name) ||"".equals(email)||"".equals(password)||"".equals(tachetitle)||"".equals(deadline)){
                    JOptionPane.showMessageDialog(new JFrame(), "entrez touts les champs !!");
                }else {
                    usersController.ajouterUser(name, email, password, tachetitle,deadline);
        ...
        btnUpdate.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (selectedRow >= 0) {
                    ...
                    usersController.modifierUser(id,nameName.getText() , emailName.getText(),passwordName.getText(), titleTachName.getText(),deadlineField.getText());   
    ...
    private void selectdata() {
        if (table.getSelectedRow() >= 0) {
            int i = table.getSelectedRow();
                ...
                titleTachName.setText(tableModel.getValueAt(i, 4).toString());     
